    ...
    <div className="font-sans min-h-screen p-8 pb-20 gap-16 sm:p-20 curvy-bg">
      <main className="space-y-4">
        <div className="flex flex-col gap-6 items-center sm:items-start">
          <h1 className="text-6xl font-extrabold leading-[1.15] text-center sm:text-left">
          ...
          <div className="flex gap-4 flex-wrap justify-center sm:justify-start">
            <Link
              href="/listings"
              className="px-6 py-3 bg-[#53ba04] text-white font-bold rounded-md hover:bg-[hsl(280,100%,60%)] transition"
            >
              Find your place
            </Link>
          </div>
